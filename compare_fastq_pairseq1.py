...
R1_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R1_primers-pass_pair-pass.fastq"
R1_FILE2 = SCRIPT_DIR / r"airr_session\ex3_full\pairseq_003\R1_q20_quality-pass_primers-pass_pair-pass.fastq"
R1_LOG_FILE = SCRIPT_DIR / "compare_fastq_pairseq1_R1_differences.log"

R2_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R2_primers-pass_pair-pass.fastq"
R2_FILE2 = SCRIPT_DIR / r"airr_session\ex3_full\pairseq_003\R2_q20_quality-pass_primers-pass_pair-pass.fastq"
R2_LOG_FILE = SCRIPT_DIR / "compare_fastq_pairseq1_R2_differences.log"
# --------------------------------
...
def main():
    compare_fastq(R1_FILE1, R1_FILE2, R1_LOG_FILE, "PairSeq1 R1 comparison")
    compare_fastq(R2_FILE1, R2_FILE2, R2_LOG_FILE, "PairSeq1 R2 comparison")
