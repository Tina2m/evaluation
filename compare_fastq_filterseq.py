...
R1_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R1_quality-pass.fastq"
R1_FILE2 = SCRIPT_DIR / r"airr_session\ex3_full\R1_q20_quality-pass.fastq"
R1_LOG_FILE = SCRIPT_DIR / "compare_fastq_filterseq_R1_differences.log"

R2_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R2_quality-pass.fastq"
R2_FILE2 = SCRIPT_DIR / r"airr_session\ex3_full\R2_q20_quality-pass.fastq"
R2_LOG_FILE = SCRIPT_DIR / "compare_fastq_filterseq_R2_differences.log"
# --------------------------------
...
def main():
    compare_fastq(R1_FILE1, R1_FILE2, R1_LOG_FILE, "FilterSeq R1 comparison")
    compare_fastq(R2_FILE1, R2_FILE2, R2_LOG_FILE, "FilterSeq R2 comparison")
