...
R1_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R1_primers-pass.fastq"
R1_FILE2 = SCRIPT_DIR / r"airr_session\ex3_full\R1_q20_quality-pass_primers-pass.fastq"
R1_LOG_FILE = SCRIPT_DIR / "compare_fastq_maskprimer_R1_differences.log"

R2_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R2_primers-pass.fastq"
R2_FILE2 = SCRIPT_DIR / r"airr_session\ex3_full\R2_q20_quality-pass_primers-pass.fastq"
R2_LOG_FILE = SCRIPT_DIR / "compare_fastq_maskprimer_R2_differences.log"
# --------------------------------
...
def main():
    compare_fastq(R1_FILE1, R1_FILE2, R1_LOG_FILE, "MaskPrimer R1 comparison")
    compare_fastq(R2_FILE1, R2_FILE2, R2_LOG_FILE, "MaskPrimer R2 comparison")
