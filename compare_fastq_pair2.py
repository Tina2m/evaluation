...
R1_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R1_consensus-pass_pair-pass.fastq"
R1_FILE2 = SCRIPT_DIR / r"airr_session2\ex3_full\pairseq_006\R1_CONS_consensus-pass_pair-pass.fastq"
R1_LOG_FILE = SCRIPT_DIR / "compare_fastq_pair2_R1_differences.log"

R2_FILE1 = SCRIPT_DIR / r"presto_pipeline\MS12_R2_consensus-pass_pair-pass.fastq"
R2_FILE2 = SCRIPT_DIR / r"airr_session2\ex3_full\pairseq_006\R2_CONS_consensus-pass_pair-pass.fastq"
R2_LOG_FILE = SCRIPT_DIR / "compare_fastq_pair2_R2_differences.log"
# --------------------------------
...
def main():
    compare_fastq(R1_FILE1, R1_FILE2, R1_LOG_FILE, "R1 comparison")
    compare_fastq(R2_FILE1, R2_FILE2, R2_LOG_FILE, "R2 comparison")
